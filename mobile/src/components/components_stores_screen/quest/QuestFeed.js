...
import Animated, { FadeIn, FadeInDown, FadeInUp, FadeOutUp, interpolate, useAnimatedStyle, useSharedValue, withDelay, withTiming } from 'react-native-reanimated'
...
export default function QuestFeed({
  ...
  return (
    <Animated.View style={[styles.container, {backgroundColor: progress == maxProgress ? COLORS.mainBackground: COLORS.ivory}]} exiting={FadeOutUp} entering={FadeIn}>
