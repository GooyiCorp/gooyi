...
// Main Section
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------
export default function InputCouponAmounts({
    setInputData,
    handleSubmit,
}) {
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------
return (
<View style={{width: '30%', marginBottom: 15, marginRight: 20}}>
    <Animated.Text style={[T4, styles.label, labelTransition]}>Menge</Animated.Text>
